...
class Datatypes {
    ...
    val v19: Float = 5.75f
    // val v20 = `1.414` некорректно.
    val v21: String = "Artificial Intelligence"
    //val v22: Array<String> = arrayOf('x', "A") некорректно, разный тип данных: char и string
    ...
    //val v32: String = “🤯” некорректно
    val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
    // val v34 = ‘65535’ Не может быть более 1 символа в char
